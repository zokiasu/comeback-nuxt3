...
<template>
  <div class="min-h-screen bg-secondary text-tertiary">
    ...
    <div class="inset-x-0 z-50 pb-4 pt-5 md:hidden">
      <img src="~/assets/image/logo.png" alt="Comeback" quality="80" loading="lazy" class="mx-auto block h-9 w-auto" />
    </div>
    ...
    <LazyYoutubePlayer ref="YTPlayer" v-if="isPlayingVideo" class="animate__animated animate__fadeInUp fixed bottom-0" />
  </div>
</template>
