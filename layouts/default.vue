...
const isAdminStore = computed(
  () => userStore.isAdminStore,
)
const isLoginStore = computed(
  () => userStore.isLoginStore,
)
...
<template>
  <div
    class="min-h-screen bg-secondary text-tertiary"
  >
    <Navigation
