<template>
  <div v-if="release != null">
    <button
      @click="playVideo(release.videoId)"
    ...
    >
      ...
      />
      <div
        class="absolute inset-0 flex flex-col items-center justify-evenly gap-8 bg-secondary/50 py-10"
      >
    ...
    <div class="flex w-full justify-end">
      <button
        @click="reloadedSong"
        class="w-fit text-xs font-semibold uppercase hover:text-primary"
      >
        Reload
      </button>
    </div>
