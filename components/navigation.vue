...
<template>
  <div class="sticky top-0 p-3 lg:p-5 z-50 transition-all duration-500 ease-in-out">
    <div ref="navbar"
      class="animate__animated animate__fadeInDown px-5 lg:p-0 rounded-full transition-all duration-500 ease-in-out">
