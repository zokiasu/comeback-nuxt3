<script setup>
	...
	const isReady = computed(() => !!(userData.value && userData.value.id && roomId.value))
			...
			meta: [
				{
					name: 'description',
					content:
						'Join or create synchronized music rooms with SyncRadio. Listen to music together, no matter where you are. Immersive and community-driven experience guaranteed!',
				},
				{
					name: 'keywords',
					content:
						'synchronized music, listen together, create music room, SyncRadio, collaborative playlists, online music, community experience',
				},
				{
					property: 'og:title',
...
<template>
	<div>
		...
		<SyncRadioApp v-else :room-id="roomId" />
	</div>
</template>
