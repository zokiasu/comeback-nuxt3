...
const uploadImageFile = async (files) => {
  ...
  console.log('storageRef', storageRef.value)
...
const updateArtist = async () => {
  ...
  set('updateArtistPending', artistToEdit.value).then(() => {
...
<template>
  <div class="container mx-auto p-5 lg:px-10 min-h-[calc(100vh-60px)] space-y-5">
    ...
    <div class="border-t border-zinc-700 pt-3">
      <button @click="updateArtist" class="bg-primary w-full rounded text-xl font-semibold uppercase py-3 hover:scale-105 hover:bg-red-900 transition-all ease-in-out duration-300">
        Saves
      </button>
    </div>
  </div>
