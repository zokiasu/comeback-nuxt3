...
useHead({
  ...
  meta: [
    ...
    },
    {
      ...
      content:
        'Comeback - Track every next release by your favorite artists.',
    },
    {
      hid: 'og:type',
      property: 'og:type',
    ...
    },
    {
      ...
      property: 'og:url',
      content:
        'https://nuxt-firebase-auth.vercel.app/',
    },
    {
      hid: 'og:image',
      property: 'og:image',
      content:
        'https://nuxt-firebase-auth.vercel.app/ogp.png',
    },
  ],
  link: [
    {
...
<template>
  <div>
    <section
      v-if="
        newsToday.length && newsFetched
      "
      class="animate__animated animate__fadeInDown"
    >
      <div class="relative">
        <div
          class="absolute z-10 pt-10"
        >
          <p
    ...
    >
      ...
      ></div>
      <div
        class="z-10 space-y-1.5 xl:space-y-5"
      >
        <p
          class="text-[2rem] font-bold sm:text-[6vw] xl:text-7xl"
        >
          Don't miss any
        ...
        <p
          class="text-[3vw] xl:text-3xl"
        >
          Track every next release by
          your favorite artists
        </p>
      </div>
      <p
        class="absolute bottom-20 left-0 right-0 md:hidden"
      >
        <icon-arrow-down
          class="mx-auto h-5 w-5 animate-bounce"
        />
      </p>
    </section>
    <section
