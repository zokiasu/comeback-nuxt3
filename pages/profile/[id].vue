<template>
	...
	>
		<div
			class="bg-quaternary-950 relative grid grid-cols-1 gap-5 rounded p-3 lg:grid-cols-2 xl:p-5"
		>
			<NuxtImg
			...
			<NuxtLink
				...
				to="/settings/profile"
				class="bg-secondary-950 absolute top-5 right-5 rounded px-2 py-1 text-xs font-semibold uppercase"
			>
				Edit Profile
			</NuxtLink>
		...
		<div class="bg-quaternary-950 space-y-5 rounded p-3 xl:p-5">
			<div class="flex items-center justify-between">
				<h2 class="text-xl font-semibold">Rankings</h2>
				<NuxtLink
					to="/ranking/create"
					class="bg-secondary-950 rounded px-2 py-1 text-xs font-semibold uppercase"
				>
					Create a Ranking
				</NuxtLink>
			</div>
