  ...
  <div v-if="releaseFetch" class="space-y-2">
    ...
    <section class="flex w-full justify-between">
      <div class="flex space-x-2">
        ...
        <button class="h-full uppercase text-xs px-2 py-1 rounded hover:bg-zinc-500" :class="needToBeVerifiedFilter ? 'bg-primary' : 'bg-quinary'" @click="needToBeVerifiedFilter = !needToBeVerifiedFilter">
          Only NTBV
        </button>
      </div>
